        ...
        success: function (data) {
            ...
            */
            ...
            var promo = data.promotion.shortName;
                        ...
                        if (promo === null) {
                            console.log("LEGE PROMOTIE");
                            promo = "";
                        }
                
                        if (promo === "GEEN PROMOTIE") {
                            promo = "";
                        }
            ...
            if ((data.stories.length) > 0) {
                ...
                if (category.toLowerCase() === "cafe".toLowerCase()) {
                    console.log('cafe');
                    nextstring = "<div class='event-head'><img class='yellow-circle' src='img/yellow-circle.svg'><img class='icon' src='" + data.icon + "'><div class='event-div'><h2>" + data.title + "</h2><h3><span>" + placename + "</span> " + data.place.address + "</h3></div></div><div class='addstory' id='addstory'><h7>CHECK IN AND ADD STORY&nbsp&nbsp<i class='material-icons'>camera_alt</i></h7></div><section class='description-one'><h4>information</h4><h5><h4 class='promo'>" + promo + "</h4></section><section class='description-twoo'><p>" + data.description + "</p><p><a class='link' href=" + data.detailLink + "></a></p><img class='coverphoto' src=" + data.coverPhoto + "></section>";

                    nextstring = "<div class='event-head'><img class='yellow-circle' src='img/yellow-circle.svg'><img class='icon' src='" + data.icon + "'><div class='event-div'><h2>" + data.title + "</h2><h3><span>" + placename + "</span> " + data.place.address + "</h3></div></div><div class='addstory' id='addstory'><h7>CHECK IN AND ADD STORY&nbsp&nbsp<i class='material-icons'>camera_alt</i></h7></div><section class='description-one'><h4>information</h4><h4 class='promo'>" + promo + "</h4></section><section class='description-twoo'><p>" + data.description + "</p><p><a class='link' href=" + data.detailLink + "></a></p><img class='coverphoto' src=" + data.coverPhoto + "></section>";

                } else {

                    nextstring = "<div class='event-head'><img class='yellow-circle' src='img/yellow-circle.svg'><img class='icon' src='" + data.icon + "'><div class='event-div'><h2>" + data.title + "</h2><h3><span>" + placename + "</span> " + data.place.address + "</h3></div></div><div class='addstory' id='addstory'><h7>CHECK IN AND ADD STORY&nbsp&nbsp<i class='material-icons'>camera_alt</i></h7></div><section class='description-one'><h4>information</h4><h5><i class='material-icons icon-small'>date_range</i> WHEN &nbsp&nbsp&nbsp&nbsp&nbsp" + OnlyDateConverter(data.startTime) + "</h5><h5><i class='material-icons icon-small'>access_time</i> START &nbsp&nbsp&nbsp " + OnlyTimeConverter(data.startTime) + "</h5><h4 class='promo'>" + promo + "</h4></section><section class='description-twoo'><p>" + data.description + "</p><p><a class='link' href=" + data.detailLink + "></a></p><img class='coverphoto' src=" + data.coverPhoto + "></section>";
